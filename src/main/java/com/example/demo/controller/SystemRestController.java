...
/**
 * The type System rest controller.
 *
 * @author Fred
 */
@EnableSwagger2
...
public class SystemRestController {
  ...
  public ResponseEntity<DemoResponse> msg() {
    ...
    Demo bean = Demo.builder().username(UUID.randomUUID().toString())
    ...
    return ResponseEntity.ok()
        .body(DemoResponse.builder().msg("Hello Fred  【" + bean.getUsername() + "】").build());
  }
   ...
   * @param acceptEnc     the accept enc
   * @param cacheCon      the cache con
